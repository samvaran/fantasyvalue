...
INCLUDE_PLAYERS = ['jordan love', 'kyle monangai', 'christian mccaffrey', 'jahmyr gibbs', 'tucker kraft']  # Force these players into every lineup (e.g., ['patrick mahomes', 'bijan robinson'])
